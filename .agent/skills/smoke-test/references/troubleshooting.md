...
This document lists common issues encountered during ActWeave smoke testing and how to resolve them.
...
3. Or stop ActWeave services first:
   ```bash
   make stop
   ```
...
#### Clean Up All ActWeave-Related Containers and Images
```bash
make docker-stop
