# ActWeave Smoke Test Standard Operating Procedure (SOP)

This document describes the detailed operating steps for each phase of the ActWeave smoke test.

## Phase 1: Code Update Check

### 1.1 Confirm Current Directory

**Objective**: Verify that the current working directory is the ActWeave project root.
...
**Success Criteria**: All ports are free, or they are occupied only by ActWeave-related processes.
...
**Success Criteria**: Port 2026 is free, or it is occupied only by an ActWeave-related process.
