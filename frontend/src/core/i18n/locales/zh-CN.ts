...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    memory: {
      title: "记忆",
      v2: {
        description: "查看长期事实、处理待整理候选，并追踪记忆的修改来源。",
        export: "导出 NDJSON",
        exportSuccess: "记忆导出已下载",
        tabs: {
          facts: "长期记忆",
          candidates: "待整理",
          history: "修改历史",
        ...
        facts: {
          title: "长期记忆",
          description:
            "启用中的事实可在后续运行中被召回；停用事实仍保留供你检查。",
          searchPlaceholder: "搜索事实内容",
          categoryPlaceholder: "按分类筛选",
          statusAll: "全部状态",
          statusActive: "启用中",
          statusDisabled: "已停用",
          count: (count) => `${count} 条事实`,
          emptyTitle: "还没有长期事实",
          emptyDescription: "记忆管线处理对话后，接受的候选会出现在这里。",
          noMatchesTitle: "没有匹配的事实",
          noMatchesDescription: "请尝试其他搜索词、分类或状态。",
          loadError: "长期记忆加载失败。",
          confidence: "置信度",
        ...
        candidates: {
          title: "待整理",
          description: "将有用候选接受为长期事实，或拒绝不应保留的候选。",
          count: (count) => `${count} 条待处理候选`,
          emptyTitle: "当前没有待整理内容",
          emptyDescription: "符合条件的对话完成提取后，新候选会出现在这里。",
          loadError: "待整理候选加载失败。",
          accept: "接受",
          reject: "拒绝",
          cannotAccept: "该候选的正文或敏感级别受限，不能接受为长期事实。",
          retention: "保留类型",
          sensitivity: "敏感级别",
        ...
        history: {
          title: "修改历史",
          description: "选择一条事实，查看历次修订和来源证据的当前状态。",
          selectTitle: "请选择一条事实",
          selectDescription:
            "从长期记忆中打开“查看历史”，修订记录会显示在这里。",
          loadError: "事实历史加载失败。",
          current: "当前事实",
          revisions: "修订记录",
          evidence: "来源证据",
          revision: (revision) => `修订 ${revision}`,
          changedBy: (actor) => `修改者：${actor}`,
          reason: (reason) => `原因：${reason}`,
          sourceAvailable: "来源可用",
          sourceDeleted: "来源已删除",
          sourceUnknown: "来源不可用",
          openThread: "打开来源会话",
          noEvidence: "该修订没有关联的来源证据。",
        },
        settings: {
          title: "记忆设置",
          description: "以下为新任务当前实际使用的运行时策略。",
          loadError: "记忆设置加载失败。",
          pipeline: "管线模式",
          enabled: "已启用",
          disabled: "已停用",
          search: "记忆搜索",
          injection: "自动召回",
          consolidationInterval: "自动整理周期",
          retention: "候选保留期",
          minutes: (value) => `${value} 分钟`,
          days: (value) => `${value} 天`,
          readOnly: "记忆运行参数由系统管理员统一管理。",
          modes: {
            off: "关闭",
            shadow: "影子模式",
            consolidate: "旧版召回",
        ...
        edit: {
          title: "编辑记忆事实",
          description: "保存后会创建新修订，旧版本继续保留在修改历史中。",
          content: "内容",
          category: "分类",
          confidence: "置信度",
          reason: "修改原因",
          reasonPlaceholder: "可选，说明本次修改原因",
          cancel: "取消",
          save: "保存修订",
          success: "事实修订已保存",
          invalidContent: "事实内容不能为空。",
          invalidCategory: "事实分类不能为空。",
          invalidConfidence: "置信度必须是 0 到 1 之间的数字。",
        },
        forget: {
          title: "要永久遗忘这条事实吗？",
          description: "这会擦除事实正文、修订和关联来源，完成后无法恢复。",
          preview: "即将擦除的事实",
          cancel: "取消",
          confirm: "永久遗忘",
          success: "事实已永久遗忘",
        },
        acceptSuccess: "候选已接受为长期事实",
        rejectSuccess: "候选已拒绝",
        disableSuccess: "事实已停止召回",
        restoreSuccess: "事实已恢复召回",
        retry: "重试",
        conflict: "记忆已被其他操作更新，请刷新后重试。",
        emptyContent: "（内容不可用）",
      },
    },
    personalization: {
      ...
      resetTitle: "重置记忆",
      resetDescription: "删除当前账号在所有项目中的长期记忆和待整理内容。",
      resetButton: "重置",
      resetDialogTitle: "要重置所有记忆吗？",
      resetDialogDescription:
        "这会永久删除长期事实、待整理候选、来源和记忆快照，完成后无法恢复。",
