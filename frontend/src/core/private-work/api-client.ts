...
export const GRAPH_RECURSION_LIMIT = "GRAPH_RECURSION_LIMIT";
export const LOOP_SAFETY_LIMIT = "LOOP_SAFETY_LIMIT";
export const LOOP_FINALIZATION_FAILED = "LOOP_FINALIZATION_FAILED";
export const OUTPUT_DELIVERY_INCOMPLETE = "OUTPUT_DELIVERY_INCOMPLETE";
export const SIDE_EFFECT_STATE_UNKNOWN = "SIDE_EFFECT_STATE_UNKNOWN";
...
export const RUN_POLICY_STALE = "RUN_POLICY_STALE";
export const TOOL_CALL_CONTROL_STATE_INVALID =
  "TOOL_CALL_CONTROL_STATE_INVALID";
export const PROVIDER_REQUEST_USAGE_UNSUPPORTED =
  "PROVIDER_REQUEST_USAGE_UNSUPPORTED";
export const PROVIDER_REQUEST_PROFILE_DRIFT = "PROVIDER_REQUEST_PROFILE_DRIFT";
export const CONTEXT_CAPACITY_EXCEEDED = "CONTEXT_CAPACITY_EXCEEDED";
export const CONTEXT_PROVIDER_CALL_AMBIGUOUS =
...
export type ProjectRunFailureCode =
  ...
  | typeof GRAPH_RECURSION_LIMIT
  | typeof LOOP_SAFETY_LIMIT
  | typeof LOOP_FINALIZATION_FAILED
  | typeof OUTPUT_DELIVERY_INCOMPLETE
  | typeof SIDE_EFFECT_STATE_UNKNOWN
  | typeof CURRENT_UPLOAD_UNAVAILABLE
  | typeof TOOL_EXECUTION_FAILED
  | typeof RUN_POLICY_STALE
  | typeof TOOL_CALL_CONTROL_STATE_INVALID
  | typeof PROVIDER_REQUEST_USAGE_UNSUPPORTED
  | typeof PROVIDER_REQUEST_PROFILE_DRIFT
  | typeof CONTEXT_CAPACITY_EXCEEDED
  | typeof CONTEXT_PROVIDER_CALL_AMBIGUOUS
