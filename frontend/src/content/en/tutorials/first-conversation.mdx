...
description: This tutorial walks you through your first complete agent conversation in ActWeave — from launching the app to getting meaningful work done with the agent.
---
...
This tutorial walks you through your first complete agent conversation in ActWeave — from launching the app to getting meaningful work done with the agent.

## Prerequisites

- ActWeave app is running (see [Quick Start](/docs/application/quick-start))
- A platform administrator has configured an active default model in **Admin → System Settings → Models**
...
The agent used the ActWeave Harness to:
