...
description: This tutorial walks you through your first complete agent conversation in Fluva — from launching the app to getting meaningful work done with the agent.
---
...
This tutorial walks you through your first complete agent conversation in Fluva — from launching the app to getting meaningful work done with the agent.

## Prerequisites

- Fluva app is running (see [Quick Start](/docs/application/quick-start))
...
The agent used the Fluva Harness to:
