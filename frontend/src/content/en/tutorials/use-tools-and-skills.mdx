...
Enable versioned Skills from project settings. Project owners and editors can create project versions or bind an allowed system version; Viewer access is read-only when the project capability permits it.
