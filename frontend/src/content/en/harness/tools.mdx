...
<Callout type="info" emoji="🔧">
  Tools are the actions the Lead Agent can take. Fluva provides built-in
...
Fluva organizes tools into four categories:
...
through Fluva's artifact system. This is useful for visual evidence, UI checks,
