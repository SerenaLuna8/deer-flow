---
title: Lead Agent
description: The Lead Agent is the central executor in an Fluva thread. Every conversation, task, and workflow flows through it. Understanding how it works helps you configure it effectively and extend it when needed.
---
...
<Callout type="info" emoji="🧠">
  ...
  Fluva thread. It decides what to do, calls tools, delegates to subagents,
  and returns artifacts.
</Callout>

The Lead Agent is the central executor in an Fluva thread. Every conversation, task, and workflow flows through it. Understanding how it works helps you configure it effectively and extend it when needed.
...
Fluva performs at most one recovery call in the same Run. It keeps the same
...
with no tool activity also offers **Retry without deep thinking**. Fluva
