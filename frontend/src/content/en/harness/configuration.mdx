...
Fluva explicitly separates infrastructure process configuration from
database-governed settings, keeping deployments reproducible, auditable, and
easy to customize per environment.

## Config file location

Fluva resolves `config.yaml` using the following priority order:
...
This pattern is how Fluva achieves pluggability without hardcoding class references.
