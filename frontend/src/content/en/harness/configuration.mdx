...
2. The `ACT_WEAVE_CONFIG_PATH` environment variable.
3. The legacy-compatible `DEER_FLOW_CONFIG_PATH` environment variable.
4. `config.yaml` in the repository root.

If both environment names are set, they must resolve to the same path.
