---
title: Customization
description: ActWeave's pluggable architecture means most parts of the system can be replaced or extended without forking the core. This page maps the extension points and explains how to use each one.
---
...
<Callout type="info" emoji="🔧">
  ActWeave is designed to be adapted. You can extend agent behavior by writing
...
ActWeave's pluggable architecture means most parts of the system can be replaced or extended without forking the core. This page maps the extension points and explains how to use each one.
...
Memory is a project-private PostgreSQL resource. Extend surrounding product behavior through the document Memory API and admitted private-run hooks. Account and project come from the authenticated client scope; owner and the fixed internal namespace remain server-owned. The runtime does not load global or filesystem Memory adapters.
