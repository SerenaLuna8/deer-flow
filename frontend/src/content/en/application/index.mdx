...
- **nginx**: routes project REST and streaming requests to Gateway, and page requests to the frontend.
...
| Reverse proxy     | nginx                                                                |
| State persistence | Gateway runtime + PostgreSQL checkpointer                             |
