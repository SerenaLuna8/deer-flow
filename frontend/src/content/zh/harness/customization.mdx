...
Memory 是项目私有的 PostgreSQL 资源。扩展其外围产品行为时，应使用项目 Memory API 和 admitted private-run hook，并始终保留精确的 account、project、owner、namespace scope。最终运行时不加载全局或文件 Memory adapter。
