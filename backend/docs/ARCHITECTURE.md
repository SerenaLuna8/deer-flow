...
- PostgreSQL：唯一业务权威；保存账户、项目、资产、私有工作、job、stream、quota、audit 和 recovery proof。
...
备份使用外部认证加密 archive；retention purge 先写外部 tombstone journal；恢复只允许新数据库，并在 replay、probe 和 proof 完成后交接 ownership。
