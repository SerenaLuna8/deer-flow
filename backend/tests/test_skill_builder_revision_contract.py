...
from app.gateway.routers.project_skill_builder import CreateSkillDesignSessionRequest
...
from app.shared_assets.skill_design_service import SkillDesignGenerationRequest
