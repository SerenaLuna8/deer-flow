...
-- Coverage: 84 static tables and 1006 columns.
...
COMMENT ON TABLE project_channel_group_bindings IS '保存外部渠道群组与项目之间的受管绑定。';
...
COMMENT ON COLUMN project_channel_group_bindings.agent_scope IS '渠道群组绑定：智能体范围。';
COMMENT ON COLUMN project_channel_group_bindings.agent_asset_id IS '渠道群组绑定：智能体资产标识。';
...
COMMENT ON COLUMN project_channel_group_bindings.deleted_at IS '渠道群组绑定：记录删除时间。';
