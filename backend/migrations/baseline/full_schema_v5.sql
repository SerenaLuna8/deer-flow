-- Frozen chain-root snapshot (full_schema_v5). NEVER EDIT: this file is the
-- immutable starting point of the incremental migration chain and must stay
-- byte-identical to the full_schema.sql that shipped the v5 marker.
BEGIN;
