...
_ACTIONS: dict[str, AuditAction] = {
    ...
    "skill.archive": AuditAction.ASSET_DEPRECATED,
    ...
    "credential.create": AuditAction.ASSET_CREDENTIAL_REPLACED,
    "credential.replace": AuditAction.ASSET_CREDENTIAL_REPLACED,
    "credential.revoke": AuditAction.ASSET_CREDENTIAL_REPLACED,
