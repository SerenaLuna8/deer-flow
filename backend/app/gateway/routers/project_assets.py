...
from app.gateway.routers.project_asset_routes import agents, skills
from app.gateway.routers.project_asset_routes.catalog import catalog_router as catalog_router
