...
- Known staged gap: 25 legacy owner-only channel router tests await workspace project-route migration and the explicit legacy cutover guard; the runnable project connection route is already mounted and green.
