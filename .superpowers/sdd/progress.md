...
- Task 9 approved at `58f5d98f`: PostgreSQL project-owner-namespace Memory, captured-scope async queue/updater, private prompt injection, callable service, and legacy compatibility are green. Task 10 has not started.
